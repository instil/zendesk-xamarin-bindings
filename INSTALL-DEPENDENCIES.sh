...
CHAT_SOCKET_CLIENT_VERSION="6.1.3"
CHAT_VERSION="3.3.6"
CHAT_PROVIDERS_VERSION="3.3.6"
CHAT_VISTOR_CLIENT_VERSION="8.3.3"
COMMON_UI_VERSION="4.0.5"
JAVA_COMMON_VERSION="2.0.0"
MESSAGING_VERSION="5.2.5"
MESSAGING_API_VERSION="5.2.5"
SDK_CONFIGURATIONS_VERSION="2.0.3"
