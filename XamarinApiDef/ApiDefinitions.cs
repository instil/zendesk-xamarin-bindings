...
namespace Binding
{
	...
	interface ZDKMessaging_ZendeskSDKMessaging_Swift_1446
	{
		...
		void InitializeWithChannelKey (string channelKey, [NullAllowed] Action<ZDKMessaging, NSError> completionHandler);
	}
	...
	interface ZDKMessagingDelegate
	{
		...
		bool ShouldHandleURL (ZDKMessaging messaging, NSUrl url, ZDKURLSource source);
	}
