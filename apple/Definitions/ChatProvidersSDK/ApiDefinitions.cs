...
namespace ZendeskiOS
{
	...
	// @interface ChatProvidersSDK_Swift_249 (ZDKChatAccountProvider)
	[Category]
	[BaseType (typeof(ZDKChatAccountProvider))]
	interface ZDKChatAccountProvider_ChatProvidersSDK_Swift_249
	{
	...
	interface ZDKChat
	{
		...
		[Static]
		[Export ("configuration", ArgumentSemantic.Strong)]
		ZDKChatAPIConfiguration Configuration { get; }
	...
	// @interface ChatProvidersSDK_Swift_413 (ZDKChat)
	[Category]
	[BaseType (typeof(ZDKChat))]
	interface ZDKChat_ChatProvidersSDK_Swift_413
	{
	...
	// @interface ChatProvidersSDK_Swift_491 (ZDKChatAPIConfiguration)
	[Category]
	[BaseType (typeof(ZDKChatAPIConfiguration))]
	interface ZDKChatAPIConfiguration_ChatProvidersSDK_Swift_491
	{
		// -(BOOL)isEqual:(id _Nullable)object __attribute__((warn_unused_result("")));
		[Export ("isEqual:")]
		bool IsEqual ([NullAllowed] NSObject @object);
	...
	// @interface ChatProvidersSDK_Swift_593 (ZDKChatComment)
	[Category]
	[BaseType (typeof(ZDKChatComment))]
	interface ZDKChatComment_ChatProvidersSDK_Swift_593
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull description;
		[Export ("description")]
		string Description { get; }
	...
	// @interface ChatProvidersSDK_Swift_638 (ZDKChatLog)
	[Category]
	[BaseType (typeof(ZDKChatLog))]
	interface ZDKChatLog_ChatProvidersSDK_Swift_638
	{
	...
	// @interface ChatProvidersSDK_Swift_670 (ZDKChatMemberJoin)
	[Category]
	[BaseType (typeof(ZDKChatMemberJoin))]
	interface ZDKChatMemberJoin_ChatProvidersSDK_Swift_670
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull description;
		[Export ("description")]
		string Description { get; }
	...
	// @interface ChatProvidersSDK_Swift_684 (ZDKChatMemberLeave)
	[Category]
	[BaseType (typeof(ZDKChatMemberLeave))]
	interface ZDKChatMemberLeave_ChatProvidersSDK_Swift_684
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull description;
		[Export ("description")]
		string Description { get; }
	...
	// @interface ChatProvidersSDK_Swift_704 (ZDKChatMessage)
	[Category]
	[BaseType (typeof(ZDKChatMessage))]
	interface ZDKChatMessage_ChatProvidersSDK_Swift_704
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull description;
		[Export ("description")]
		string Description { get; }
	...
	// @interface ChatProvidersSDK_Swift_726 (ZDKChatOptionsMessage)
	[Category]
	[BaseType (typeof(ZDKChatOptionsMessage))]
	interface ZDKChatOptionsMessage_ChatProvidersSDK_Swift_726
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull description;
		[Export ("description")]
		string Description { get; }
	...
	// @interface ChatProvidersSDK_Swift_815 (ZDKChatRating)
	[Category]
	[BaseType (typeof(ZDKChatRating))]
	interface ZDKChatRating_ChatProvidersSDK_Swift_815
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull description;
		[Export ("description")]
		string Description { get; }
	...
	// @interface ChatProvidersSDK_Swift_833 (ZDKRatingRequest)
	[Category]
	[BaseType (typeof(ZDKRatingRequest))]
	interface ZDKRatingRequest_ChatProvidersSDK_Swift_833
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull description;
		[Export ("description")]
		string Description { get; }
	...
	// @interface ChatProvidersSDK_Swift_916 (ZDKChatState)
	[Category]
	[BaseType (typeof(ZDKChatState))]
	interface ZDKChatState_ChatProvidersSDK_Swift_916
	{
	...
	// @interface ChatProvidersSDK_Swift_921 (ZDKChatState)
	[Category]
	[BaseType (typeof(ZDKChatState))]
	interface ZDKChatState_ChatProvidersSDK_Swift_921
	{
		// -(BOOL)isEqual:(id _Nullable)object __attribute__((warn_unused_result("")));
		[Export ("isEqual:")]
		bool IsEqual ([NullAllowed] NSObject @object);
	...
	// @interface ChatProvidersSDK_Swift_989 (ZDKDepartment)
	[Category]
	[BaseType (typeof(ZDKDepartment))]
	interface ZDKDepartment_ChatProvidersSDK_Swift_989
	{
		// @property (readonly, copy, nonatomic) NSString * _Nonnull description;
		[Export ("description")]
		string Description { get; }
...
*/[Protocol]
	...
	// @interface ChatProvidersSDK_Swift_1079 (ZDKOfflineForm)
	[Category]
	[BaseType (typeof(ZDKOfflineForm))]
	interface ZDKOfflineForm_ChatProvidersSDK_Swift_1079
	{
		// -(BOOL)isEqual:(id _Nullable)object __attribute__((warn_unused_result("")));
		[Export ("isEqual:")]
		bool IsEqual ([NullAllowed] NSObject @object);
	...
	// @interface ChatProvidersSDK_Swift_1158 (ZDKPushNotificationData)
	[Category]
	[BaseType (typeof(ZDKPushNotificationData))]
	interface ZDKPushNotificationData_ChatProvidersSDK_Swift_1158
	{
		// -(BOOL)isEqual:(id _Nullable)object __attribute__((warn_unused_result("")));
		[Export ("isEqual:")]
		bool IsEqual ([NullAllowed] NSObject @object);
	...
	// @interface ChatProvidersSDK_Swift_1332 (ZDKVisitorPath)
	[Category]
	[BaseType (typeof(ZDKVisitorPath))]
	interface ZDKVisitorPath_ChatProvidersSDK_Swift_1332
	{
		// -(BOOL)isEqual:(id _Nullable)object __attribute__((warn_unused_result("")));
		[Export ("isEqual:")]
		bool IsEqual ([NullAllowed] NSObject @object);
